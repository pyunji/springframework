        ...
        <div class="card m-2">
            ...
            <script>
                function requestPost() {
                    ...
                    const param2 = $("#param2").val(); // 생년월일: 19680615 (o) 19803014(x)
                    const param3 = $("#param3").val(); // 패스워드: 알파벳으로 시작 최소 8자 최대 10자
                    const param4 = $("#form1 input[name=param4]:checked").val(); // 안해도됨
                    const param5 = $("#param5").val(); // 위에서 복사해서 쓰면 됨
                    ...
                    // 1. /[0-9]{6}[-][1-4]{1}[0-9]{6})/g
                    // 2. /(19|20)[0-9]{2}[01-12][01-31]/g
                    // 3. /[a-zA-Z]\S{7,9}/g
